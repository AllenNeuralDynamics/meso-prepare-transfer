...
class UiUserSettings(object):
    def setupUi(self, UserNameLineEdit):
        ...
        UserNameLineEdit.resize(190, 190)
        UserNameLineEdit.setMinimumSize(QSize(190, 190))
        UserNameLineEdit.setMaximumSize(QSize(190, 190))
        palette = QPalette()
        ...
        self.userNameLabel.setGeometry(QRect(40, 20, 101, 16))
        font = QFont()
        ...
        self.submitPushButton.setGeometry(QRect(40, 140, 111, 24))
        palette1 = QPalette()
        ...
        self.sesssionIdLabel.setGeometry(QRect(40, 80, 101, 16))
        ...
        self.sessionIdLineEdit.setGeometry(QRect(40, 110, 113, 22))
