...
class UiUserSettings(object):
    def setupUi(self, UserNameLineEdit):
        if not UserNameLineEdit.objectName():
            UserNameLineEdit.setObjectName(u"UserNameLineEdit")
        ...
        brush1 = QBrush(QColor(96, 224, 150, 255))
        brush1.setStyle(Qt.SolidPattern)
        palette.setBrush(QPalette.Active, QPalette.Button, brush1)
        brush2 = QBrush(QColor(190, 255, 218, 255))
        brush2.setStyle(Qt.SolidPattern)
        palette.setBrush(QPalette.Active, QPalette.Light, brush2)
        brush3 = QBrush(QColor(143, 239, 184, 255))
        brush3.setStyle(Qt.SolidPattern)
        palette.setBrush(QPalette.Active, QPalette.Midlight, brush3)
        brush4 = QBrush(QColor(48, 112, 75, 255))
        brush4.setStyle(Qt.SolidPattern)
        palette.setBrush(QPalette.Active, QPalette.Dark, brush4)
        brush5 = QBrush(QColor(64, 149, 100, 255))
        ...
        brush7 = QBrush(QColor(175, 239, 202, 255))
        ...
        brush10 = QBrush(QColor(48, 112, 75, 127))
        brush10.setStyle(Qt.SolidPattern)
#if QT_VERSION >= QT_VERSION_CHECK(5, 12, 0)
        palette.setBrush(QPalette.Disabled, QPalette.PlaceholderText, brush10)
#endif
        brush11 = QBrush(QColor(145, 255, 192, 255))
        ...
        self.subjectIdLineEdit.setObjectName(u"subjectIdLineEdit")
        self.subjectIdLineEdit.setGeometry(QRect(40, 120, 113, 22))
        self.subjectIdLabel = QLabel(UserNameLineEdit)
        self.subjectIdLabel.setObjectName(u"subjectIdLabel")
        ...
        self.submitPushButton.setObjectName(u"submitPushButton")
        ...
        self.sesssionIdLabel.setObjectName(u"sesssionIdLabel")
        ...
        self.sessionIdLineEdit.setObjectName(u"sessionIdLineEdit")
    ...
    def retranslateUi(self, UserNameLineEdit):
        UserNameLineEdit.setWindowTitle(QCoreApplication.translate("UserNameLineEdit", u"Schema", None))
        self.userNameLabel.setText(QCoreApplication.translate("UserNameLineEdit", u"User Name", None))
        self.subjectIdLabel.setText(QCoreApplication.translate("UserNameLineEdit", u"Subject ID", None))
        self.submitPushButton.setText(QCoreApplication.translate("UserNameLineEdit", u"Submit", None))
        self.sesssionIdLabel.setText(QCoreApplication.translate("UserNameLineEdit", u"Session ID", None))
    # retranslateUi
